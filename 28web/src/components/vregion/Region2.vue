<template>
    <div>
        ...
        <select :class="className" v-model="nowArea" v-if="!text && !ui && ((area && city) || !haveCity) && listArea.length">
            <option value="" v-if="blank">{{lang.pleaseSelect}}</option>
        ...
        <v-dropdown v-if="ui" ref="dropdown">
            ...
            <div class="rg-results-container">
                <ul class="rg-results">
                    <!-- <li :class="{'rg-item':true,active:matchItem(item),selected: item.selected}" -->
                    <li :class="{'rg-item':true,selected: item.selected}"
        ...
        div.rg-results-container{
            ...
            ul.rg-results {
                ...
                li.rg-item {
                    ...
                    &.selected { border: 1px solid #f00;background-color: #DDDDDD; }
                }
                & > li {
                    /*height: auto;
                    line-height: 1;*/
