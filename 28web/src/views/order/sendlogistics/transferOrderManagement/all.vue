    ...
    <div class="columnsContainer">
      <div class="side_right">
        <el-form :inline="true" ref="ruleForm" class="divide" size="mini">
          <el-form-item label="中转单状态">
            <el-select v-model="formData.outsourceStatus" clearable placeholder="请选择">
              <el-option label="已揽收" :value="1"></el-option>
              <el-option label="未揽收" :value="0"></el-option>
            </el-select>
          </el-form-item>
          ...
          <div class="info_news">
            ...
            >
              ...
              <el-table-column prop="carrierServiceMobile" sortable min-width="200" label="专线承运商客服电话"></el-table-column>
                <el-table-column prop="outsourceStatus" sortable min-width="150" label="中转单状态"></el-table-column>
...
<script type="text/javascript">
    ...
    export default {
      ...
      methods: {
        handleClick() {
          exportListExcel(this.formData).then(res => {
            if (res.status) {
            ...
            NewDom.setAttribute('download', '全部中转订单.xls')
