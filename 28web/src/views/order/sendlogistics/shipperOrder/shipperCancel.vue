<template>
    <div class="identicalStyle shipperCancelCompnent" v-loading="loading">
        ...
        return {
            ...
            listSystemObj:{
                ...
                "vo": {
                    ...
                    "startAddress": "",//发货地
                    "startUseTime": "",//下单开始时间
                    "statusQueryType": "5",//订单状态查询类型（1:全部；2：区代超时未受理；3：区代超时未揽货；4：区代拒单；5：货主取消发货）
                }
            },
            chooseTime1:[],
            tableData: [],
