<template>
    <div class="identicalStyle overTimeNoCargoCompnent" v-loading="loading">
        ...
        <div class="classify_info">
            <div class="btns_box">
                <el-button type="primary" icon="el-icon-error" plain @click="handleClick('cancel')" :size="btnsize">代货主取消发货</el-button>
            </div>
            <div class="info_news">
                <el-table
                    ref="multipleTable"
        ...
        :before-close="close">
            ...
            <div slot="footer" class="dialog-footer">
                <el-button type="primary" plain icon="el-icon-success" @click="submitForm('ruleForm')">确认取消发货</el-button>
...
import { logisticsShipperOrderList,logisticsShipperOrderCancel } from '@/api/order/logistics/logistics1.js'
import Pager from '@/components/Pagination/index'
import { parseTime } from '@/utils/index';
import { logisticsCancelType } from '@/api/common'
export default{
    name:'overTimeNoCargoCompnent',
    props: {
        isvisible: {
            type: Boolean,
            default: false
        ...
        return {
            ...
            listSystemObj:{
                ...
                "vo": {
                    ...
                    "startAddress": "",//发货地
                    "startUseTime": "",//下单开始时间
                    "statusQueryType": "3",//订单状态查询类型（1:全部；2：区代超时未受理；3：区代超时未揽货；4：区代拒单；5：货主取消发货）
                }
            },
            chooseTime1:[],
            tableData: [],
        ...
        submitForm(formName) {
            this.$refs[formName].validate((valid) => {
                if (valid) {
                    ...
                    logisticsShipperOrderCancel( this.form).then(res => {
                        this.$message({
                            type: 'success',
                            message: '代货主取消发货成功！'
                        })
