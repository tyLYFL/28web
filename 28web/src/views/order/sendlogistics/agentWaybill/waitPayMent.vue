<template>
    <div class="identicalStyle waitPayMentCompnent" v-loading="loading">
        ...
        return {
            ...
            listSystemObj:{
                ...
                "vo": {
                    ...
                    "statusQueryType": "3",//运单状态查询类型（1:全部列表；2：代区代操作列表；3：待货主支付运费列表）
                    "waybillNo": "",//运单号
                    "waybillStatus": ""//运单状态
                }
            },
            ...
            switch (type) {
                case 'export':
                    ...
                    exportAgentWaybillExcal(this.listSystemObj.vo).then(res => {
                        ...
                        NewDom.setAttribute('download', '发物流-区代运单管理-待货主支付运费-'+parseTime(timestamp)+'.xlsx');
