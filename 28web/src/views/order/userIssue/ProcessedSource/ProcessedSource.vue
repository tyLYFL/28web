<template>
 <div class="identicalStyle waitCarriySource" style="height:100%" >
         ...
         <el-button type="primary"  plain  @click="clearSearch" :size="btnsize" icon="fontFamily aflc-icon-qingkong">清空</el-button>
            ...
            <div class="btns_box">
             <el-button  type="primary" plain icon="el-icon-remove"  :size="btnsize" v-if="status.name=='shangjia'" @click="SoldOut"  v-has:ORDER_ORDER_GOODS_MANAGE_DEAL_IN_SHELF_THE_OUTSELF>下架</el-button>
             <el-button  type="primary" plain icon="el-icon-circle-plus"  :size="btnsize" v-if="status.name=='xiajia'"  @click="SoldIn"  v-has:ORDER_ORDER_GOODS_MANAGE_DEAL_OFF_SHELVES_THE_INSELF>上架</el-button>
