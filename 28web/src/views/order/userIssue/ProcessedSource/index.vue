<template>
    <div class="ProcessedSource tabsWrap">
        <el-tabs type="card" @tab-click="handleClick" v-model="orderTabName">
            ...
            >
            <ProcessedSource :status = "item" :isshow="orderTabName === item.name" @Ochange = 'Ochange'></ProcessedSource> 
...
<script>
import ProcessedSource from './ProcessedSource.vue'
...
export default {
    data(){
        return{
            ...
            visibleTabs:[
                {label:"上架中",name:"shangjia",type:'AF0491401',num:'0',code:'ORDER_ORDER_GOODS_MANAGE_DEAL_IN_SHELF'},
                {label:"已下架",name:"xiajia",type:'AF0491402',num:'0',code:'ORDER_ORDER_GOODS_MANAGE_DEAL_OFF_SHELVES'},
            ]
        }
    },
    components:{
    ...
    InfoCout(){
            findFCLSoldInfoCount({dealState:'1'}).then(res=>{
                if(res.data){
