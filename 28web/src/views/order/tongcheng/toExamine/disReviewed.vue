<template>
    <div class="identicalStyle clearfix disReviewed" v-loading="loading">
...
export default{
  ...
  data() {
    return {
        ...
        listSystemObj:{
            ...
            "pageSize": 20,
            "vo": {
                "auditStatus": "AF0850604",//审核状态（待审核 AF0850601、待复审 AF0850602、已复审 AF0850603、复审不通过 AF0850604）
            }
        },
        tableData: [],
        selected:{},
  ...
  methods: {
    ...
    getSearchParam(obj) {
        ...
        this.listSystemObj.vo.auditStatus = "AF0850604";
