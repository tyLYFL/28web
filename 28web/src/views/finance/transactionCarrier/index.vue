    ...
    <div class="identicalStyle" style="height:100%" v-loading="loading">
          ...
          <div class="classify_info">
           ...
           <el-table-column label="序号"   width="60">
            ...
            <el-table-column  label="专线承运商名称" prop="agencyOrLineName" sortable show-overflow-tooltip width=""></el-table-column>
...
export default {
  data() {
    ...
    firstblood() {
      this.loading = true
      data_findMywalletTotal(this.page, this.pagesize, this.formAllData,'AF00113').then(res => {
    ...
    pushOrderSerial(item) {
      this.$router.push({ name: '专线承运商账户详情', query: { Id: item.accountId}})
