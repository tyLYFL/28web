<template>
    <div class="identicalStyle" style="height:100%" v-loading="loading">
          ...
          <div class="classify_info">
            <div class="btns_box">
            专线承运商名称：<span class="pr50 titleName">{{agencyOrLineName?agencyOrLineName:''}}</span>账户余额：<span class="pr50">¥{{balance}}</span>
           ...
           <el-table-column label="序号"   width="60">
            ...
            <el-table-column  label="交易流水号" prop="tradeNo" sortable show-overflow-tooltip width=""></el-table-column>
            ...
            <el-table-column  label="剩余余额" prop="balance" sortable show-overflow-tooltip width=""></el-table-column>
            </el-table>
        	</div> 
         <!-- 页码 -->
...
export default {
  ...
  methods: {
    getMoreInformation() {
      findAflcMywalletByAccountId(this.$route.query.Id,'AF00113').then(res=>{
    ...
    importExcel(){
        ...
        data_aflcMywalletDetailListExcel(0, 0,this.formAllData).then(res=>{
            ...
            NewDom.setAttribute('download', '专线承运商账户概况账户余额.xls');
