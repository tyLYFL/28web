    ...
    methods: {
        init(){
            aflcBusinessGroupUserList(this.listSystemObj).then(res=>{
                // console.log('aflcBusinessGroupUserList',res)
        ...
        handleSelect(value){
            // console.log(value,this.belongSalesmanName)
        ...
        if(this.restaurants.length<1){
            this.$message.warning('请先选择业务组~') 
        }
        }
    },
    mounted(){
        // console.log('customerNamecustomerNamecustomerName',this.groupCode,this.belongSalesman)
        // this.belongSalesmanName = this.customerName ? this.customerName : '';
