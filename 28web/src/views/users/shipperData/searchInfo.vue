<template>
    <el-form :inline="true" :model="searchInfo" ref="ruleForm" class="demo-ruleForm classify_searchinfo" >
        <el-form-item  label="货主姓名：" prop="shipperName">
             <el-input v-model="searchInfo.shipperName" clearable></el-input>
        </el-form-item>
        <el-form-item label="注册账号：" prop="mobile">
            <el-input v-model="searchInfo.mobile" clearable></el-input>
        </el-form-item>
        <el-form-item label="所属客服：" maxlength="18"  prop="shipperName">
            <el-input v-model="searchInfo.aa" clearable disabled></el-input>
        </el-form-item>
        <el-form-item label="所属业务员：" maxlength="18"  prop="shipperName">
            <el-input v-model="searchInfo.aa" clearable disabled placeholder="账户/姓名"></el-input>
        </el-form-item>
