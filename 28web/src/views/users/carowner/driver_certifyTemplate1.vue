<template> 
    <div class="StyleNewinfoComponent shippercreatDialog commoncss driverDialog">
        ...
        <el-col :span="8">
            <el-form-item label="用户姓名：" :label-width="formLabelWidth" prop="driverName">
            <el-input auto-complete="off" v-model="templateModel.driverName" :maxlength="20"></el-input>
            </el-form-item>
        </el-col>
        <el-col :span="8">
            <el-form-item label="手机号码：" :label-width="formLabelWidth" prop="driverMobile">
            <el-input auto-complete="off" v-model="templateModel.driverMobile" :maxlength="11"></el-input>
            </el-form-item>
        </el-col>
        <el-col :span="8">
            <el-form-item label="身份证号码：" :label-width="formLabelWidth" prop="cardid">
            <el-input auto-complete="off" v-model="templateModel.cardid" :maxlength="18"></el-input>
            </el-form-item>
        </el-col>
        </el-row>
        <el-row>
        <el-col :span="8">
            <el-form-item label="性别：" :label-width="formLabelWidth" prop="">
                <el-select v-model="templateModel.sex" placeholder="请选择">
                    <el-option
        ...
        <el-col :span="8">
            ...
            <el-input auto-complete="off" v-model="templateModel.age" :maxlength="3"></el-input>
            </el-form-item>
        </el-col>
        <el-col :span="8">
            <el-form-item label="生日：" :label-width="formLabelWidth" prop="">
            <el-date-picker
            v-model="templateModel.birthday"
            type="date"
            placeholder="选择日期">
            </el-date-picker>
            </el-form-item>
        ...
        <el-row>
        <el-col :span="8">
            <el-form-item label="认证所在地：" :label-width="formLabelWidth" prop="belongCityName">
        ...
        <el-col :span="8">
            ...
            <el-input auto-complete="off" v-model="templateModel.nation" :maxlength="10"></el-input>
            </el-form-item>
        </el-col>
        <el-col :span="8">
        ...
        <el-row>
        <el-col :span="8">
            <el-form-item label="注册所在地："  :label-width="formLabelWidth" prop="regisAddress">
        ...
        <el-col :span="8">
            ...
            <el-input auto-complete="off" v-model="templateModel.address"></el-input>
            </el-form-item>
        </el-col>
        <el-col :span="8">
        ...
        <el-row>
            <el-col :span="8">
                <el-form-item label="账户登录状态：" :label-width="formLabelWidth" >
                    <el-button type="primary" icon="el-icon-circle-check-outline" :size='UseBtntype' @click="isOnLine(0)" v-if="templateModel.isOnLine=='1'">是</el-button>
                    <el-button type="info" icon="el-icon-circle-close-outline" :size='UseBtntype' @click="isOnLine(1)" v-else>否</el-button>
                </el-form-item>
            </el-col>
            <el-col :span="8">
        ...
        <el-form-item prop="" label="图片审核状态：">
        <el-select v-model="radio6" placeholder="请选择" class="radioselect">
            <el-option
        ...
        <el-form-item prop="" label="图片审核状态：">
        <el-select v-model="radio7" placeholder="请选择" class="radioselect">
            <el-option
                v-for="item in caroptions"
                :key="item.value"
                :label="item.value"
        ...
        <el-col :span="8">
            <el-form-item label="档案编号：" :label-width="formLabelWidth" prop="fileNumberLicense">
            <el-input auto-complete="off" v-model="templateModel.fileNumberLicense"></el-input>
            </el-form-item>
        </el-col>
        <el-col :span="8">
            <el-form-item label="国籍：" :label-width="formLabelWidth">
            <el-input auto-complete="off"  v-model="templateModel.nationality"></el-input>
            </el-form-item>
        </el-col>
        <el-col :span="8">
            <el-form-item label="准驾车型：" :label-width="formLabelWidth">
            <el-input auto-complete="off"  v-model="templateModel.classType"></el-input>
            </el-form-item>
        </el-col>
        </el-row>
        ...
        <el-col :span="8">
            ...
            {{templateModel.vldEndLicenceExpire}}
            </el-form-item>
        </el-col>
        </el-row>
        ...
        <el-form-item label="驾驶证签发机关：" :label-width="formLabelWidth">
            <el-input auto-complete="off" v-model="templateModel.signOrgLicense"></el-input>
        </el-form-item>   
        </el-col>         
        </el-row>
        <el-row :gutter="20"> 
        ...
        <el-form-item prop="" label="图片审核状态：">
        <el-select v-model="radio1" placeholder="请选择" class="radioselect">
            <el-option
                v-for="item in caroptions"
                :key="item.value"
                :label="item.value"
        ...
        <el-form-item prop="" label="图片审核状态：">
        <el-select v-model="radio2" placeholder="请选择" class="radioselect">
            <el-option
                v-for="item in caroptions"
                :key="item.value"
                :label="item.value"
        ...
        <el-col :span="8">
            ...
            <el-input auto-complete="off" v-model="templateModel.carNumber"></el-input>
            </el-form-item>
        </el-col>
        <el-col :span="8">
            <el-form-item label="所有人：" :label-width="formLabelWidth" prop="owner">
            <el-input auto-complete="off" v-model="templateModel.owner"></el-input>
            </el-form-item>
        </el-col>
        <el-col :span="8">
            <el-form-item label="使用性质：" :label-width="formLabelWidth" >
            <el-input auto-complete="off" v-model="templateModel.useType"></el-input>
            </el-form-item>
        </el-col>
        </el-row>
        <el-row>
        <el-col :span="8">
            ...
            <el-input auto-complete="off" v-model="templateModel.brandType"></el-input>
            </el-form-item>
        </el-col>
        <el-col :span="8">
            <el-form-item label="车辆识别代号：" :label-width="formLabelWidth" >
            <el-input auto-complete="off" v-model="templateModel.vin"></el-input>
            </el-form-item>
        </el-col>
        <el-col :span="8">
            <el-form-item label="发动机号：" :label-width="formLabelWidth" >
            <el-input auto-complete="off" v-model="templateModel.engineNo"></el-input>
            </el-form-item>
        </el-col>        
        </el-row>
        <el-row>
        ...
        <el-col :span="8">
            ...
            <el-input auto-complete="off" v-model="templateModel.fileNumber"></el-input>
            </el-form-item>
        </el-col>
        </el-row>
        <el-row>
        ...
        <el-form-item prop="" label="图片审核状态：">
        <el-select v-model="radio3" placeholder="请选择" class="radioselect">
            <el-option
                v-for="item in caroptions"
                :key="item.value"
                :label="item.value"
        ...
        <el-form-item prop="" label="图片审核状态：">
        <el-select v-model="radio4" placeholder="请选择"  class="radioselect">
            <el-option
                v-for="item in caroptions"
                :key="item.value"
                :label="item.value"
        ...
        <el-form-item prop="" label="图片审核状态：">
        <el-select v-model="radio5" placeholder="请选择" class="radioselect">
            <el-option
                v-for="item in caroptions"
                :key="item.value"
                :label="item.value"
        ...
        <el-row style="margin-bottom:22px;">
                   ...
                   <el-table
                   :data="templateModel.aflcBusinessInformationList"
                   border
                   ref="multipleTable"
                   stripe
                   align = "center"
        ...
        <el-col :span="8">
              ...
              >{{templateModel.recommenderName}}<span v-if="templateModel.recommenderName&&templateModel.recommenderPhone">-</span>{{templateModel.recommenderPhone}}</el-form-item>
            </el-col>
        <el-col :span="8">
            <el-form-item label="推荐人用户类型：" :label-width="formLabelWidth">
            {{templateModel.recommenderUserTypeCode}}   
            </el-form-item>
        </el-col>
        </el-row>
        <el-col :span="8">
            <el-form-item label="推荐渠道：" :label-width="formLabelWidth">
            {{templateModel.recommendedChannelName}}
            </el-form-item>
        </el-col>
        <el-row>
        <el-col :span="8">
            <el-form-item label="推荐人所属业务员：" :label-width="formLabelWidth">
            {{templateModel.recommenderSalesmanName}}
            </el-form-item>
        </el-col>
        <el-col :span="8">
            <el-form-item label="被推荐人注册时间：" :label-width="formLabelWidth">
            {{templateModel.recommendederRegisterTime|parseTime}}
            </el-form-item>
        </el-col>
        </el-row>
        ...
        <el-col :span="8">
            ...
            <el-button type="primary" icon="el-icon-circle-check-outline" :size='UseBtntype' @click="isVipCar(0)" v-if="templateModel.isVipCar=='1'">是</el-button>
            <el-button type="info" icon="el-icon-circle-close-outline" :size='UseBtntype' @click="isVipCar(1)" v-else>否</el-button>
            </el-form-item>
        </el-col>
        <el-col :span="8">
            <el-form-item label="需要后续跟进状态：" :label-width="formLabelWidth" >
                <el-button type="primary" icon="el-icon-circle-check-outline" :size='UseBtntype' @click="driverFollowUp(0)" v-if="templateModel.driverFollowUp=='1'">是</el-button>
                <el-button type="info" icon="el-icon-circle-close-outline" :size='UseBtntype' @click="driverFollowUp(1)" v-else>否</el-button>
            </el-form-item>
        </el-col>  
        <el-col :span="8">
            <el-form-item label="是否广告车：" :label-width="formLabelWidth" >
                <el-button type="primary" icon="el-icon-circle-check-outline" :size='UseBtntype' @click="isAd(0)" v-if="templateModel.isAd=='1'">是</el-button>
                <el-button type="info" icon="el-icon-circle-close-outline" :size='UseBtntype' @click="isAd(1)" v-else>否</el-button>
            </el-form-item>
        </el-col> 
        </el-row>
        <el-row>
        ...
        <el-col :span="24">
            <el-form-item label="审核备注：" :label-width="formLabelWidth" class="remarkformlabel">
                  <el-input
                    ...
                    clearable
                    maxlength="100"
                    v-model="templateModel.businessGroupRemark">
                    </el-input>
            </el-form-item>
        </el-col>
        </el-row>
...
<script>
import {data_get_driverName_id,data_post_audit,data_post_checkDriverCarNumber} from '@/api/users/carowner/all_car.js'
...
export default {
  name:'template-create-view-change',
    ...
    //    车牌号信息校验
       ...
       selectFlag:false,
       caroptions: [{value: '上传合格',label: ''},{value: '不清晰',label: '不清晰'},{value: '内容不符',label: '内容不符'}],   //图片审核状态
       ...
       draverAudit:false,   //审核校验状态
       rulesForm:{
        driverName:{required: true, message:'用户姓名不能为空', trigger:'change'},
        ...
        cardid:{validator: cardidValidator, trigger:'change',required:true},
        birthday:{required: true, message:'请选择生日', trigger:'change'},
        carNumber:{validator: carNumberValidator, trigger:'change',required:true},
        fileNumberLicense:{required: true, message:'档案编号不能为空', trigger:'change'},
        owner:{required: true, message:'所用人不能为空', trigger:'change'},
        carType:{required: true, message:'车辆类型不能为空', trigger:'change'},  
        belongCityName:{required: true, message:'认证所在地不能为空', trigger:'change'},
        regisAddress:{required: true, message:'注册所在地不能为空', trigger:'change'},
   ...
   methods:{
       ...
       this.driverTemplateDialogFlag = false    
        ...
        let newVldEndArarry = newVldEnd[0]+'-'+newVldEnd[1]+'-'+newVldEnd[2]
        ...
        this.templateModel.regisAddress = (!d.province&&!d.city&&!d.area&&!d.town) ? '': `${this.getValue(d.province)}${this.getValue(d.city)}${this.getValue(d.area)}${this.getValue(d.town)}`.trim();
        if(d.area){
        ...
        completeData(){
                  if(this.radio6==null){
                      this.$message.info('请选择车主身份证照片审核结果');
                      return false
                  }
                  if(this.radio7==null){
                      this.$message.info('请选择车主个人形象照片审核结果');
                      return false
                  }
                  if(this.radio1==null){
                      this.$message.info('请选择驾驶证照片审核结果');
                      return false
                  }
                  if(this.radio2==null){
                      this.$message.info('请选择驾驶证照副页照片审核结果');
                      return false
                  }
                  if(this.radio3==null){
                      this.$message.info('请选择车辆行驶证照片审核结果');
                      return false
                  }
                  if(this.radio4==null){
                      this.$message.info('请选择车辆行驶证副本照片审核结果');
                      return false
                  }        
                  if(this.radio5==null){
                      this.$message.info('请选择车辆45°照片审核结果');
                      return false
                  }                   
        },
        ...
        // 审核通过
        handlerPass(){
        var forms=Object.assign({},this.templateModel,this.authNoPassCause,{driverStatus:"AF0010403"})
        this.$refs['templateModel'].validate((valid)=>{
            ...
            if(this.radio1==''&&this.radio2==''&&this.radio3==''&&this.radio4==''&&this.radio5==''&&this.radio6==''&&this.radio7=='')
            {
            this.driverTemplateDialogFlag = false   
            this.$message.info('审核通过提交中...')   
        ...
        // 审核不通过
        handlerOut(){
        var forms=Object.assign({},this.templateModel,this.authNoPassCause,{driverStatus:"AF0010404"})
        console.log('forms',this.authNoPassCause)
        if(this.completeData()==false)
         {
         return
         }
   ...
   computed:{
    // 图片审核计算
    authNoPassCause:function(){
             return {
                 authNoPassCauseIdCard:this.radio6,
                 authNoPassCauseOfPersonal:this.radio7,
                 authNoPassCauseOfDrivingLicence:this.radio1,
                 authNoPassCauseDrivingLicenceOpposite:this.radio2,
                 authNoPassCauseDrivingPermit:this.radio3,
                 authNoPassCauseDrivingPermitOpposite:this.radio4,
                 authNoPassCauseOfCar:this.radio5,
             }
    },
   },
   mounted(){
