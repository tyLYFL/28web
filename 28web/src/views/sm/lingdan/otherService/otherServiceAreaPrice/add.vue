        ...
        <el-dialog :title='formtitle' :close-on-click-modal="false" v-el-drag-dialog top="5vh" :visible="dialogFormVisible" @close="close">
            <el-form   :model="standForm" :rules="newrules" label-position="right"  ref="ruleForm"  :label-width="formLabelWidth">
                ...
                <!-- <el-row :gutter="20" v-if="!isBatch">
                    <el-col :span="10">
                        <el-form-item  label="区域：" prop="provinceCode" class="currentArea" v-if="!isModify">
                            <el-select v-model="standForm.provinceCode" clearable placeholder="请选择" >
                                <el-option
                         ...
                         <el-form-item  label="区域：" class="currentArea is-required" v-else>
                            <el-input :value="standForm.province+standForm.area" disabled></el-input>
                        </el-form-item>
                    </el-col>
                    <el-col :span="6" v-if="!isModify">
                        <el-form-item label="" prop="totalAreaCodeArr" label-width="0px">
                            <el-select v-model="standForm.totalAreaCodeArr"  multiple collapse-tags :loading="loadingCIty" @focus="getCityList" clearable placeholder="请选择">
                                <el-option
                ...
                <el-row :gutter="20">
                    <el-col :span="12">
                        <el-form-item  label="费率(千分之)：" prop="agencyRate">
                            ...
                            <!-- <el-input v-model="standForm.agencyRate" v-numberOnly placeholder="元"></el-input> -->
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
