                ...
                <!-- <el-row :gutter="20" v-if="!isBatch">
                   <el-col :span="10">
                        <el-form-item  label="选择出发地：" prop="startCode" v-if="!isModify">
                            <getCityList class="chooseItem" @returnStr="getStrStart" :isArea="false" v-model="standForm.startCode" ref="startArea"></getCityList>
                        </el-form-item>
                    ...
                    <el-col :span="6" v-if="!isModify">
                        <el-form-item label="" prop="totalStratAreaCode" label-width="0px">
                            <el-select v-model="standForm.totalStratAreaCode"  multiple collapse-tags :loading="loadingStartCIty" @focus="getStartAreaList" clearable placeholder="请选择">
                                <el-option
                ...
                <el-row :gutter="20">
                   <el-col :span="10">
                        <el-form-item  label="选择到达地：" prop="endCode" v-if="!isModify">
                            <getCityList class="chooseItem" @returnStr="getStrEnd" v-model="standForm.endCode" placeholderTxt="选择到达城市" ref="endArea"></getCityList>
                        </el-form-item>
...
export default {
    ...
    data() {
      ...
      return {
        ...
        optionseAreaAgency:[],
        remarkList:[{
            label:'当需要批量更新区代路线定价时，可直接使用“新增区代运作路线及定价”批量新增功能，覆盖原有定价。'
        }],
      };
    },
    watch:{
    ...
    methods: {
        ...
        completeName(){
            if(!this.isModify){
                ...
                for(var i=0;i< this.standForm.totalEndAreaCode.length;i++){
                    totalStratAreaName.push(this.standForm.agencyAreaName);
                    totalStratAreaCode.push(this.standForm.agencyAreaCode);
                }
                this.standForm.totalStratArea = totalStratAreaName;
                this.standForm.totalStratAreaCode = totalStratAreaCode;
