...
<script>
import {data_get_couponActiveauto_list,data_Del_couponActive,data_Able_couponActive,data_automationActive,} from '@/api/marketing/shippermarkting/couponActive.js'
...
export default {
    ...
    methods:{
     ...
     mounted(){
         ...
         this.firstblood();
         if(this.$route.query.activityType=='one'){
            this.type = "view";
            this.typetitle = '详情';
            this.dialogFormVisible_add = true;
