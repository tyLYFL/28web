<template>
    <div class="identicalStyle getPastCompnent" v-loading="loading">
        <el-form  :inline="true" :model="listSystemObj.vo" ref="ruleForm" class="demo-ruleForm classify_searchinfo">
            ...
            <el-form-item label="初审结果" prop="status">
                <el-select v-model="listSystemObj.vo.status" clearable placeholder="请选择">
                    <el-option
                    v-for="item in optionsFirstTrialType"
                    :key="item.code"
                    :label="item.name"
                    :value="item.code">
                    </el-option>
    ...
    data() {
        return {
            ...
            listSystemObj:{
                ...
                "pageSize": 20,
                "vo": {
                    status:'AF0880602,AF0880603,AF0880604',//【待初审审核】显示：待初审审核（AF0880601） 【初审已审核】显示：初审通过（AF0880602）、初审驳回（AF0880603）、初审不通过（AF0880604）
            ...
            optionsFirstTrialType:[{
                name:'全部',
                code:"AF0880602,AF0880603,AF0880604"
            },{
                name:'初审通过',
                code:"AF0880602"
            },{
