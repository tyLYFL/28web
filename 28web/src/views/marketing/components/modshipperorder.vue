        ...
        <el-form :model="formAll" ref="formAll" :rules="rulesForm" :inline="true">
          <el-row >
            ...
            <tbody>
             ...
             <th >区域优惠额度上限</th>
             <th >服务分类</th>
             <th v-if="formAll.serivceCode!=='AF01702'&&formAll.serivceCode">车辆类型</th>
             <th >启用状态</th>
            </tr>
            <tr>
             ...
             <td v-if="formAll.serivceCode!=='AF01702'&&formAll.serivceCode">
...
import { data_get_shipperOwnerFrom_update,data_get_shipperPreferDetail_Id} from '@/api/marketing/shippermarkting/shipperOwner.js'
  ...
  methods:{
   ...
   close:function(){
    ...
    getMoreInformation(){
          ...
          update1:function(Id){
            data_get_shipperPreferDetail_Id(Id).then(res=>{
            ...
            let ZZ = 0;
            this.formAll.reward1 = res.data.preferentialDetailList[0].startPrice;this.formAll.reward2 = res.data.preferentialDetailList[0].endPrice;
            this.formAll.reward3 = res.data.preferentialDetailList[1].startPrice;this.formAll.reward4 = res.data.preferentialDetailList[1].endPrice;
            this.formAll.reward5 = res.data.preferentialDetailList[2].startPrice;this.formAll.reward6 = res.data.preferentialDetailList[2].endPrice;
            this.formAll.reward7 = res.data.preferentialDetailList[3].startPrice;this.formAll.reward8 = res.data.preferentialDetailList[3].endPrice;
            this.formAll.reward9 = res.data.preferentialDetailList[4].startPrice;this.formAll.reward10 = res.data.preferentialDetailList[4].endPrice;
            this.formAll.reward11 = res.data.preferentialDetailList[5].startPrice;this.formAll.reward12 = res.data.preferentialDetailList[5].endPrice;
            this.formAll.reward13 = res.data.preferentialDetailList[6].startPrice;this.formAll.reward14 = res.data.preferentialDetailList[6].endPrice;
            this.formAll.reward15 = res.data.preferentialDetailList[7].startPrice;this.formAll.reward16 = res.data.preferentialDetailList[7].endPrice;
            this.formAll.maxnum1 = res.data.preferentialDetailList[0].orderNum;this.formAll.maxnum2 = res.data.preferentialDetailList[8].orderNum;
            this.formAll.maxnum3 = res.data.preferentialDetailList[16].orderNum;this.formAll.maxnum4 = res.data.preferentialDetailList[24].orderNum;
            this.formAll.maxnum5 = res.data.preferentialDetailList[32].orderNum;this.formAll.maxnum6 = res.data.preferentialDetailList[40].orderNum;
            this.formAll.personalLimit1 = res.data.preferentialDetailList[0].personalLimit;this.formAll.personalLimit2 = res.data.preferentialDetailList[8].personalLimit;
            this.formAll.personalLimit3 = res.data.preferentialDetailList[16].personalLimit;this.formAll.personalLimit4 = res.data.preferentialDetailList[24].personalLimit;
            this.formAll.personalLimit5 = res.data.preferentialDetailList[32].personalLimit;this.formAll.personalLimit6 = res.data.preferentialDetailList[40].personalLimit;
           for(let II = 0;II<6;II++){
           for(let JJ = 0;JJ<8;JJ++){
           ZZ++;
           this.formAll['data'+ZZ] = res.data.preferentialDetailList[ZZ-1].reward
           this.formAll['id'+ZZ] = res.data.preferentialDetailList[ZZ-1].id
           }
           }
            })
         },
   ...
   updata_data(){
       ...
       for(let forItemI = 1;forItemI<7;forItemI++){
           for(let forItemJ = 1;forItemJ<9;forItemJ++){
            forItemZ++
            this.FormData.aflcShipperPreferentialtDetailList.push({
