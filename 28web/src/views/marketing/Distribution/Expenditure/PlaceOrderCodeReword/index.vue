<template>
    <div class="identicalStyle placeOrderCodeReword" v-loading="loading">
        <el-form :inline="true" :model="listSystemObj" ref="ruleForm" class="demo-ruleForm classify_searchinfo">
            ...
            <el-form-item label="下单码所属货主" prop="orderCodeOwnerNameOrPhone">
        ...
        <div class="classify_info">
            <div class="btns_box">
                <el-button type="primary" icon="el-icon-download" plain :size="btnsize" @click="handleClick('copy')" v-has:MARKETING_DISTRIBUTION_EXPENCE_PLACE_ORDER_REWARD_EXPORT_EXCEL>导出EXCEL</el-button>
			</div>
            <div class="info_news">
                <el-table
                :data="tableData" 
...
import { orderCodeList } from '@/api/marketing/distribution'
import Pager from '@/components/Pagination/index'
import { SaveAsFile } from '@/utils/lodopFuncs'
import { parseTime } from '@/utils/index.js'

export default{
    name:'placeOrderCodeReword',
    components: {
        Pager,
    },
    data() {
    ...
    methods: {
        ...
        firstblood() {
            this.loading = true;
            orderCodeList(this.listSystemObj).then(res => {
        ...
        handleClick(){
            SaveAsFile({
                ...
                name: '下单码奖励-' + parseTime(new Date(), '{y}{m}{d}{h}{i}{s}')
            })
        }
    }
}
