<template>
    <div class="identicalStyle ShipperBusinessReword" v-loading="loading">
        <el-form :inline="true" :model="listSystemObj" ref="ruleForm" class="demo-ruleForm classify_searchinfo">
            ...
            <el-form-item label="车主推荐人" prop="userRecommenderPhoneOrNameOrPlateNumber">
                <el-input v-model="listSystemObj.vo.userRecommenderPhoneOrNameOrPlateNumber" placeholder="账户/姓名/车牌号" clearable></el-input>
            </el-form-item>
        ...
        <div class="classify_info">
            <div class="btns_box">
                <el-button type="primary" icon="el-icon-download" plain :size="btnsize" @click="handleClick('copy')" v-has:MARKETING_DISTRIBUTION_EXPENCE_DRIVER_ORDER_REWARD_EXPORT_EXCEL>导出EXCEL</el-button>
			</div>
            <div class="info_news">
                <el-table
                :data="tableData" 
...
import { DriverBusinessReword } from '@/api/marketing/distribution'
...
export default{
        ...
        return {
            ...
            listSystemObj:{
                ...
                "vo": {
                    ...
                    // rewardType:'AF06402',//奖励类型（AF06401：奖励推荐货主的用户，AF06402：奖励推荐车主的用户）
    ...
    methods: {
        ...
        firstblood() {
            this.loading = true;
            DriverBusinessReword(this.listSystemObj).then(res => {
        ...
        handleClick(){
            SaveAsFile({
                ...
                name: '推荐车主业务奖励-' + parseTime(new Date(), '{y}{m}{d}{h}{i}{s}')
            })
        }
    }
}
