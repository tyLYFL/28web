<template>
    <div class="identicalStyle OrderTakeTotal" v-loading="loading">
        <el-form :inline="true" :model="listSystemObj" ref="ruleForm" class="demo-ruleForm classify_searchinfo">
            ...
            <el-form-item label="接单码所属车主" prop="orderCodeUserNameOrPhoneOrPlateNumber">
                <el-input v-model="listSystemObj.vo.orderCodeUserNameOrPhoneOrPlateNumber" placeholder="手机号/姓名/车牌号"  clearable></el-input>
            </el-form-item>
...
import { OrderTakeTotal } from '@/api/marketing/distribution'
...
export default{
    ...
    methods: {
        ...
        firstblood() {
            this.loading = true;
            OrderTakeTotal(this.listSystemObj).then(res => {
